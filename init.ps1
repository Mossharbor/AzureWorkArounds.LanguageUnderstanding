...
$env:SLN_NAME = "Mossharbor.AzureWorkArounds.LanguageUnderstanding.sln"
$env:SLN_RUNSETTINGS_NAME = "Mossharbor.AzureWorkArounds.LanguageUnderstanding.runsettings"
$env:NUGETVERSIONPROPSPATH = $env:Root
$env:NUGETVERSIONPROPSPATH += "\.build\dependency.version.props"
$env:VERSIONFILE = ${env:ROOT}
$env:VERSIONFILE +=  "\Mossharbor.AzureWorkArounds.LanguageUnderstanding\Package.nuspec"
